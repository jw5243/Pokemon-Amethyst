package com.horse.utility.Graphics.MapEngine;
...
public class MultiTmxTiledMapLoader extends TmxMapLoader {
    private int offsetX;
    private int offsetY;
    
    public MultiTmxTiledMapLoader() {
        setOffsetX(0);
        setOffsetY(0);
    }
    
    public MultiTmxTiledMapLoader(int offsetX, int offsetY) {
        setOffsetX(offsetX);
        setOffsetY(offsetY);
    }
