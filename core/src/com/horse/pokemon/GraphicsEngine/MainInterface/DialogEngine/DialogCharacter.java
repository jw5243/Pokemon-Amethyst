...
public enum DialogCharacter {
    ...
    J_LOWER(54, 26, 5), K_UPPER(60, 13), K_LOWER(60, 26), L_UPPER(66, 13), L_LOWER(67, 26, 3), M_UPPER(72, 13),
    M_LOWER(72, 26), N_UPPER(78, 13), N_LOWER(78, 26), O_UPPER(84, 13), O_LOWER(84, 26), P_UPPER(90, 13),
    P_LOWER(90, 26), Q_UPPER(96, 13), Q_LOWER(96, 26), R_UPPER(102, 13), R_LOWER(102, 26), S_UPPER(108, 13),
