...
public class CharacterWriter {
    ...
    public void draw(Batch batch, float parentAlpha) {
        batch.draw(getDialogCharacter().getLetterTextureRegion(), getCharacterXPosition(), getCharacterYPosition(), getCharacterWidth(), getCharacterHeight());
    }
    
    private DialogCharacter getCharacterTextureRegion(char primitiveCharacter) {
        return (primitiveCharacter == ' ') ? DialogCharacter.SPACE : (primitiveCharacter == 'A') ? DialogCharacter.A_UPPER : (primitiveCharacter == 'a') ? DialogCharacter.A_LOWER :
                                                                                                                             ...
                                                                                                                             (primitiveCharacter == '0') ? DialogCharacter.ZERO :
                                                                                                                             (primitiveCharacter == '1') ? DialogCharacter.ONE :
                                                                                                                             (primitiveCharacter == '2') ? DialogCharacter.TWO :
                                                                                                                             (primitiveCharacter == '3') ? DialogCharacter.THREE :
                                                                                                                             ...
                                                                                                                             (primitiveCharacter == '7') ? DialogCharacter.SEVEN :
                                                                                                                             (primitiveCharacter == '8') ? DialogCharacter.EIGHT :
