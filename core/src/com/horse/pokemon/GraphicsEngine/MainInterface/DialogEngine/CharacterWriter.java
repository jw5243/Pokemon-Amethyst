...
public class CharacterWriter {
    ...
    public void draw(Batch batch, float parentAlpha) {
        batch.draw(getDialogCharacter().getLetterTextureRegion(), getCharacterXPosition(), getCharacterYPosition(), getCharacterWidth(),
                   getCharacterHeight()
        );
    }
    
    private DialogCharacter getCharacterTextureRegion(char primitiveCharacter) {
        return (primitiveCharacter == ' ') ? DialogCharacter.SPACE : (primitiveCharacter == 'A') ? DialogCharacter.A_UPPER :
                                                                     ...
                                                                     (primitiveCharacter == '9') ? DialogCharacter.NINE : DialogCharacter.SPACE;
    }
}
