...
public class CalculateStats {
    public static void main(String[] args) {
        ...
        for(int i = 1; i <= 100; i++) {
            ...
            System.out.println(
                    String.format("{Level = %s, Health = %s, Attack = %s, Defense = %s, Special Attack = %s, Special Defense = %s, Speed = %s}", pokemon.getInformation().getCurrentLevel(),
    ...
    public static int[] getStats(Pokemon pokemon) {
        ...
        int[] stats = new int[6];
        stats[0] = calculateHealth
                           .calculateStat(pokemon.getInformation().getCurrentLevel(), pokemon.getInformation().getBaseStats()[0], pokemon.getInformation().getIndividualValue().getHealth(),
                                          pokemon.getInformation().getEffortValue().getHealthEV()
                           );
        stats[1] = calculateOtherStat
                           .calculateStat(pokemon.getInformation().getCurrentLevel(), pokemon.getInformation().getBaseStats()[1], pokemon.getInformation().getIndividualValue().getAttack(),
                                          pokemon.getInformation().getEffortValue().getAttackEV()
                           );
        stats[2] = calculateOtherStat
                           .calculateStat(pokemon.getInformation().getCurrentLevel(), pokemon.getInformation().getBaseStats()[2], pokemon.getInformation().getIndividualValue().getDefense(),
                                          pokemon.getInformation().getEffortValue().getDefenseEV()
                           );
        ...
        stats[5] = calculateOtherStat
                           .calculateStat(pokemon.getInformation().getCurrentLevel(), pokemon.getInformation().getBaseStats()[5], pokemon.getInformation().getIndividualValue().getSpeed(),
                                          pokemon.getInformation().getEffortValue().getSpeedEV()
                           );
